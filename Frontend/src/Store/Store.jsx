...
const [currentFriend, setCurrentFriend] = useState(friendsList[0]); // Default to the first friend in the lis
  ...
  const contextValue = useMemo(
    ...
    [isCardOpen, activeTab, user, friendsList, setCurrentFriend, currentFriend, isSidebarOpen]
  );
